...
class FornecedorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fornecedor" do
    assert_difference('Fornecedor.count') do
      post fornecedors_url, params: { fornecedor: { ativo: @fornecedor.ativo, endereco: @fornecedor.endereco, fone: @fornecedor.fone, nome: @fornecedor.nome, vendedor: @fornecedor.vendedor } }
    end
  ...
  test "should update fornecedor" do
    patch fornecedor_url(@fornecedor), params: { fornecedor: { ativo: @fornecedor.ativo, endereco: @fornecedor.endereco, fone: @fornecedor.fone, nome: @fornecedor.nome, vendedor: @fornecedor.vendedor } }
