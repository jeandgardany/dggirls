...
class ComprasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create compra" do
    assert_difference('Compra.count') do
      post compras_url, params: { compra: { data: @compra.data, fornecedor_id: @compra.fornecedor_id, pagamento: @compra.pagamento, produto: @compra.produto, valor: @compra.valor } }
    end
  ...
  test "should update compra" do
    patch compra_url(@compra), params: { compra: { data: @compra.data, fornecedor_id: @compra.fornecedor_id, pagamento: @compra.pagamento, produto: @compra.produto, valor: @compra.valor } }
