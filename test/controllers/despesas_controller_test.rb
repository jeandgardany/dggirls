...
class DespesasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create despesa" do
    assert_difference('Despesa.count') do
      post despesas_url, params: { despesa: { data: @despesa.data, nome: @despesa.nome, obs: @despesa.obs, valor: @despesa.valor } }
    end
  ...
  test "should update despesa" do
    patch despesa_url(@despesa), params: { despesa: { data: @despesa.data, nome: @despesa.nome, obs: @despesa.obs, valor: @despesa.valor } }
