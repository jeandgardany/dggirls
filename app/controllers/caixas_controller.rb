class CaixasController < ApplicationController
  ...
  private
    ...
    def caixa_params
      params.require(:caixa).permit(:data, :compra_id, :despesa_id, :venda_id, :costura_id, :corte_id, :total_entradas, :total_saidas, :saldo, :extras, :obs, :total_perdas, :estampa_id)
    end
end
